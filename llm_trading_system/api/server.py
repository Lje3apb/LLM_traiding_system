...
async def live_session_websocket(websocket: WebSocket, session_id: str, token: str = "") -> None:
    ...
    Security:
        ...
        - Invalid tokens result in connection close with code 4401
    ...
    if not user_id:
        # Reject connection with custom close code 4401 (Unauthorized)
        # Standard close codes: 1000-1015 are reserved
